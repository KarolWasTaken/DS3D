...
class InfoBoxClass(object):
    def infoBox(event):
        ...
        infoCanvas.pack()  
        labelTitle = tk.Label(infoRoot, text= "Welcome to DS3D!", font=("Yu Gothic", 30))    # Courier Century Gothic
        labelSubtitle = tk.Label(infoRoot, text= "How To Use DS3D", font=("Franklin Gothic Book", 15, "bold"))
        labelText = tk.Label(infoRoot, text= "This is a pretty simple program to use. When the counter has loaded in, press 'y' \
on your keyboard to bring up the options menu. In there you'll be able to edit the number of hits, font, font and \
...
steam account and family share Dark Souls 3 to it ", font=("Century Gothic", 10), wraplength=450, anchor="w", justify=LEFT)
        labelText3 = tk.Label(infoRoot, text= "To see this menu again press 'i' on the hitcount.", font=("Century Gothic", 10))
